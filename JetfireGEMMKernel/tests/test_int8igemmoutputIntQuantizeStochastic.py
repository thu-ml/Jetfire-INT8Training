...
def quantize_validation():
    for m, n, k, b in [(128, 256, 32, 32), (512, 512, 64, 32)]: # 
        ...
        output_igemm, scale_igemm = BQC.igemm_output_int_quantize_stochastic(qx, qw, sx.t().contiguous(), sw, m, n, k)
...
accumulate_quantize_validation(repeat_time=1000)