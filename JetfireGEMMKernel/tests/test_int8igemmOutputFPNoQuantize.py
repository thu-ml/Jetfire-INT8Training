...
def quantize_validation():
    for m, n, k, b in [(128, 256, 32, 32), (512, 512, 64, 32), (1024, 2048, 3072, 32)]: # 
        ...
        RQoutput_igemmfp = BQC.igemm_output_fp_no_quantize(qx, qw, sx.t().contiguous(), sw, m, n, k)
...
#         # output_igemm = quantized_Ofp_igemm_v1(qx, qw, sx, sw, m, n, k)
#         RQoutput_igemmfp = BQC.igemm_output_fp_no_quantize(qx, qw, sx, sw, m, n, k)
...
#     error_rate = compute_relative_error(RQoutput_igemmfp, output_torch)
#     print(f"Relative Error When M = {m}, N = {n}, K = {k}, B = {b}, = {error_rate:.6f}")
#     error_rate = compute_relative_error(Accumulate_igemmfp, output_torch)
#     print(f"Relative Error When M = {m}, N = {n}, K = {k}, B = {b}, = {error_rate:.6f}")
